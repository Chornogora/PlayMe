...
public interface UserRepository extends JpaRepository<User, String>, FilteredUserRepository {

    Optional<User> findByLogin(String login);

    Optional<User> findByLoginOrEmail(String login, String email);

    @Query(value = "SELECT COUNT(u) FROM User u WHERE u.login LIKE CONCAT('%', :#{#filterBean.login}, '%') " +
    ...
    int getUsersCount(@Param("filterBean") FilterBean filterBean);
}
