...
public class TrackController {
    ...
    @Autowired
    public TrackController(FileService fileService, RecordService recordService, MonitorCache monitorCache) {
        this.fileService = fileService;
        this.recordService = recordService;
        this.monitorCache = monitorCache;
    }

    @GetMapping(value = "/{trackId}", produces = "audio/wav")
    public ResponseEntity<Resource> getTrack(@PathVariable String trackId) {
        ...
        Object monitor = monitorCache.getMonitorByName(track.getFileUrl());
